...
public partial class @PlayerInput : IInputActionCollection2, IDisposable
{
    ...
    public struct PointerActions
    {
        ...
        public void SetCallbacks(IPointerActions instance)
        {
            ...
            {
                @PositionChange.started -= m_Wrapper.m_PointerActionsCallbackInterface.OnPositionChange;
                @PositionChange.performed -= m_Wrapper.m_PointerActionsCallbackInterface.OnPositionChange;
                @PositionChange.canceled -= m_Wrapper.m_PointerActionsCallbackInterface.OnPositionChange;
                @Tap.started -= m_Wrapper.m_PointerActionsCallbackInterface.OnTap;
                @Tap.performed -= m_Wrapper.m_PointerActionsCallbackInterface.OnTap;
                @Tap.canceled -= m_Wrapper.m_PointerActionsCallbackInterface.OnTap;
            }
